...
set PORT=1234
set MODEL_URL=https://huggingface.co/JMingo/gemma-4-E2B-it-ultra-uncensored-heretic-UD-GGUF/resolve/main/gemma-4-E2B-it-ultra-uncensored-heretic-Q4_K_M.gguf
set MODEL_FILE=gemma-4-E2B-it-ultra-uncensored-heretic-Q4_K_M.gguf
